sudo apt install --yes git vim curl wget telnet screen moreutils coreutils safe-rm retry proxychains4
...
wget https://github.com/zx9597446/qtunnel/releases/download/v0.0.1/qtunnel-linux-amd64 && chmod +x qtunnel-linux-amd64 && sudo mv qtunnel-linux-amd64 /usr/local/bin/qtunnel

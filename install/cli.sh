...
wget https://github.com/zx9597446/qtunnel/releases/latest/download/qtunnel-linux-amd64 && chmod +x qtunnel-linux-amd64 && sudo mv qtunnel-linux-amd64 /usr/local/bin/qtunnel
